...
export default (props: propsType) => {
  const { show, title = '提示', textAlign = 'center' as any, content = '',onCancel, onConfirm, onHide, cancelText = '取消', confirmText = '确定', showClose = true, children, confirmHide = true } = props;
