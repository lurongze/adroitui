...
export { default as AdDivider } from "./components/divider/index";
export { default as AdFooter } from "./components/footer/index";
export { default as AdHCDialog } from "./components/half-screen-dialog/index";
export { default as AdList } from "./components/list/index";
export { default as AdMessageList } from "./components/list/messageList";
...
export { default as AdScrollNotice } from "./components/scroll-notice/index";
