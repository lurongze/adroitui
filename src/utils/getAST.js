...
export function getMarkdownTokens(data, html = false) {
  const md = new markdownIt({
    ...
    highlight: function(str, lang) {
      if (lang) {
        try {
          return `<div class='pre'>${Prism.highlight(
            str,
  ...
  return md.parse(data, {});
}

export function getFuncTokens(codeStr) {
  return Prism.tokenize(codeStr, Prism.languages.javascript);
}

export function weMarkToken(md, options) {
